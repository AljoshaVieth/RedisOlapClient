...
import de.aljoshavieth.redisolapclient.denormalizedapproach.{Q1_2_denormalized, Q2_1_denormalized, Q2_2_denormalized, Q2_3_denormalized, Q3_1_denormalized}
...
object Main {
	...
	private val jedisURI = new URI("redis://localhost:6382")
